...
<body>
  ...
  <section class="first-body">
    ...
    <div class="container hidden">
      <div class="row">
        ...
        <div class="col-6 graph-first-para graph-first-para2 floating">
  ...
  <section class="second-body">
    <div class="container hidden">
      <div class="row">
        <div class="col-6 graph-second-para graph-second-para2 floating">
        ...
        <div class="col-6">
          ...
          <p>At the depths of the Mariana Trench lies the Challenger Deep, the most extreme place on earth,
             ...
             We do offer diving suits for those who are worried, but we're sure you won't need it.
          </p>
        </div>
      </div>
    </div>
